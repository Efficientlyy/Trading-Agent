...
This module integrates the deep learning pattern recognition models with the
Trading-Agent system, providing a standardized API for pattern signals.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("dl_integration.log"),
