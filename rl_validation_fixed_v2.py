...
from rl_agent_fixed_v2 import PPOAgent
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("rl_validation_fixed_v2.log"),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger("rl_validation_fixed_v2")
...
class RLFrameworkValidator:
    ...
    def __init__(self, 
                 test_data_path=None,
                 results_dir="validation_results_fixed_v2",
                 config_path=None):
