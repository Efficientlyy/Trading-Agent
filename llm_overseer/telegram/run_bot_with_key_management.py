#!/usr/bin/env python
"""
Run script for Telegram bot with key management.
This script runs the Telegram bot with key management features.
"""
import os
import sys
import logging
...
from .bot_with_key_management import TelegramBotWithKeyManagement
...
async def main():
    ...
    try:
        ...
        # Initialize bot
        bot = TelegramBotWithKeyManagement(config)
        ...
        logger.info("Starting Telegram bot with key management")
        await bot.run()
