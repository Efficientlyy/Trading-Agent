#!/usr/bin/env python
"""
Run script for LLM-powered Telegram bot.
This script runs the Telegram bot with true AI-powered natural language understanding.
"""
import os
import sys
import logging
...
from .llm_powered_bot import LLMPoweredTelegramBot
