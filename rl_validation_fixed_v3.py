...
from rl_agent_fixed_v3 import PPOAgent
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("rl_validation_fixed_v3.log"),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger("rl_validation_fixed_v3")
...
class RLFrameworkValidator:
    ...
    def __init__(self, 
                 test_data_path=None,
                 results_dir="validation_results_fixed_v3",
                 config_path=None):
