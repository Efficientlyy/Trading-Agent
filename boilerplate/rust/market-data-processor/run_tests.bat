@echo off
:: Windows batch file for running paper trading integration tests
...
if %ERRORLEVEL% == 0 (
    ...
    set PAPER_TRADING_INITIAL_BALANCE_USDT=10000
    set PAPER_TRADING_INITIAL_BALANCE_BTC=1
    set MAX_POSITION_SIZE=1.0
    set DEFAULT_ORDER_SIZE=0.1
    set MAX_DRAWDOWN_PERCENT=10
    set TRADING_PAIRS=BTCUSDT,ETHUSDT
